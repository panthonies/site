...
:balloon: <span style = "color:black">Welcome to my blog! You can find all of my posts on this page. <small>[tags:  [all]({{ site.baseurl }}/posts.html)]</small></span>
:balloon:
...
###### Notes on predictive modeling and application of the *caret* package; based on [Applied Predictive Modeling](http://appliedpredictivemodeling.com) by Kuhn and Johnson. 
...
###### Notes on R for Data Science; based loosely on [R for Data Science](https://r4ds.had.co.nz/index.html) by Grolemund and Wickham.
